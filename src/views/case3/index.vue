...
import {Scene,Clock,WebGLRenderer,Group,sRGBEncoding,PerspectiveCamera,LoadingManager,MeshPhongMaterial,DirectionalLight,PointLight} from 'three'
...
const initThree = ()=>{
  ...
  camera1.position.set(19, 1.54, -.1)
  ...
  const tick = () => {
    ...
    TWEEN.update()
    secondContainer ? renderer2.render(scene, camera2) : renderer1.render(scene, camera1)
